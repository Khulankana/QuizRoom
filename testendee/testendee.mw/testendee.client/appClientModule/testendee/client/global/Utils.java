...
public class Utils {
	...
	public static Object doLookup(String lookup, boolean writeErrLog, boolean throwNamingException)
		...
		try {
			...
			if (throwNamingException)
				throw new TestendeeException(CommonError.LOOKUP_ERROR);
		}
		return ret;
	}
	...
	public static boolean isString(String clsName) {
		return clsName.contains(CLASS_NAME_STRING);
	}
	...
	public static boolean isChar(String clsName) {
		return clsName.contains(CLASS_NAME_CHAR) || clsName.contains(CLASS_NAME_CH);
	}

	public static <T> boolean isChar(Class<T> cls) {
		String clsName = cls.getName();
		return clsName.contains(CLASS_NAME_CHAR) || clsName.contains(CLASS_NAME_CH);
	}

	public static boolean isBool(String clsName) {
		return clsName.contains(CLASS_NAME_BOOLEAN) || clsName.contains(CLASS_NAME_BOOL);
	}

	public static <T> boolean isBool(Class<T> cls) {
		String clsName = cls.getName();
		return clsName.contains(CLASS_NAME_BOOLEAN) || clsName.contains(CLASS_NAME_BOOL);
	}
	...
	public static boolean isInt(String clsName) {
		return clsName.contains(CLASS_NAME_INTEGER) || clsName.contains(CLASS_NAME_INT);
	}

	public static <T> boolean isInt(Class<T> cls) {
		String clsName = cls.getName();
		return clsName.contains(CLASS_NAME_INTEGER) || clsName.contains(CLASS_NAME_INT);
	}

	public static boolean isLong(String clsName) {
		return clsName.contains(CLASS_NAME_LONG) || clsName.contains(CLASS_NAME_L);
	}
	...
	public static boolean isDouble(String clsName) {
		return clsName.contains(CLASS_NAME_DOUBLE) || clsName.contains(CLASS_NAME_DBL);
	}

	public static <T> boolean isDouble(Class<T> cls) {
		String clsName = cls.getName();
		return clsName.contains(CLASS_NAME_DOUBLE) || clsName.contains(CLASS_NAME_DBL);
	}

	public static boolean isFloat(String clsName) {
		return clsName.contains(CLASS_NAME_FLOAT) || clsName.contains(CLASS_NAME_F);
	}

	public static <T> boolean isFloat(Class<T> cls) {
		String clsName = cls.getName();
		return clsName.contains(CLASS_NAME_FLOAT) || clsName.contains(CLASS_NAME_F);
	}

	public static boolean isBigDecimal(String clsName) {
		return clsName.contains(CLASS_NAME_BIGDECIMAL);
	}

	public static <T> boolean isBigDecimal(Class<T> cls) {
		String clsName = cls.getName();
		return clsName.contains(CLASS_NAME_BIGDECIMAL);
	}

	public static boolean isByte(String clsName) {
		return clsName.contains(CLASS_NAME_BYTE) || clsName.contains(CLASS_NAME_BT);
	}

	public static <T> boolean isByte(Class<T> cls) {
		String clsName = cls.getName();
		return clsName.contains(CLASS_NAME_BYTE) || clsName.contains(CLASS_NAME_BT);
	}

	public static boolean isNumber(String clsName) {

		return (isByte(clsName) || isInt(clsName) || isLong(clsName) || isFloat(clsName) || isDouble(clsName)
				|| isBigDecimal(clsName));

	}

	public static <T> boolean isNumber(Class<T> cls) {
		return (isByte(cls) || isInt(cls) || isLong(cls) || isFloat(cls) || isDouble(cls) || isBigDecimal(cls));
	}
...
//						throw e;
	...
	public static String toJSON(Object obj) {
		...
		if (obj.getClass() == Date.class || obj instanceof Date)
			return "\"" + Converter.toDateTimeStr((Date) obj) + "\"";
